"""
Expression-related tools for querying GTEx and other expression databases.
"""
...
def register_expression_tools(mcp: FastMCP) -> None:
    """Register all expression-related tools with the MCP server."""
